...
<html>
  <head>
      <meta charset="utf-8" />
      <title>OnShouldersOfGiants</title>
...
.source.python .variable.parameter {
  ...
  <body class='markdown-preview'><h1>On the shoulders of giants</h1>
<p><a href="http://spring.io">Spring</a> has a rap for being complex.   Developers just starting out with
...
just software development in a large, heterogeneous, complex environment.</p>
<p>If you’ve ever had to deploy, maintain, develop and test apps in an enterprise
without Spring you know what I mean.</p>
<p>As the <a href="http://docs.spring.io/spring-framework/docs/current/spring-framework-reference/html/overview.html">Spring Overview</a> states</p>
<blockquote>
...
Patterns are formalized best practices that you must implement yourself in your application.</p>
</blockquote>
<p>The first thing almost any developer can tell you about Spring is that it uses
Dependency Injection / Inversion of Control to build applications.  While true,
it is also incomplete.</p>
<p>Spring actually uses the whole acronym!  <a href="http://butunclebob.com/ArticleS.UncleBob.PrinciplesOfOod">S.O.L.I.D</a>
Those famous 5 principles, named first by <a href="http://cleancoder.com">Robert C. Martin (Uncle Bob)</a>.</p>
<table>
<tr>
<th> S </th>
<td> SRP</td>
...
<p><a href="https://www.youtube.com/watch?v=DJF_sGOs2V4">OCP + DIP = Never Rewrite!</a></p></body>
</html>
